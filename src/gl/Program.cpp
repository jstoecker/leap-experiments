...
{
	if (!v.empty()) {
		glUniform2fv(glGetUniformLocation(id(), name), (GLsizei)v.size(), (const GLfloat*)(&v[0]));
	}
}
...
{
	if (!v.empty()) {
		glUniform3fv(glGetUniformLocation(id(), name), (GLsizei)v.size(), (const GLfloat*)(&v[0]));
	}
}
...
{
	if (!v.empty()) {
		glUniform4fv(glGetUniformLocation(id(), name), (GLsizei)v.size(), (const GLfloat*)(&v[0]));
	}
}
